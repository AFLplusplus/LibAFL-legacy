...
afl_engine_t *initialize_broker(char *in_dir, char *queue_dir, int argc, char *argv[], u32 instance) {
  ...
  det_stage->funcs.add_mutator_to_stage(
      det_stage, (afl_mutator_t *)afl_mutator_deterministic_new(afl_mutate_bitflip_det, afl_get_iters_bitflip_det));
  det_stage->funcs.add_mutator_to_stage(
      det_stage, (afl_mutator_t *)afl_mutator_deterministic_new(afl_mutate_det_flip_two, afl_get_iters_flip_two_det));
  det_stage->funcs.add_mutator_to_stage(
      det_stage, (afl_mutator_t *)afl_mutator_deterministic_new(afl_mutate_det_flip_four, afl_get_iters_flip_four_det));
  det_stage->funcs.add_mutator_to_stage(
      det_stage, (afl_mutator_t *)afl_mutator_deterministic_new(afl_mutate_det_flip_byte, afl_get_iters_flip_byte_det));
  det_stage->funcs.add_mutator_to_stage(det_stage, (afl_mutator_t *)afl_mutator_deterministic_new(
                                                       afl_mutate_det_flip_two_byte, afl_get_iters_flip_two_byte_det));
