...
For decl and call, use AFL_NEW_DECL/CALL_PARAMS
*/
...
#define AFL_NEW_DECL_PARAMS(...) __VA_ARGS__
#define AFL_NEW_CALL_PARAMS(...) ret, __VA_ARGS__

#define AFL_NEW_AND_DELETE_FOR(init_type) AFL_NEW_AND_DELETE_FOR_WITH_PARAMS(init_type, , ret)
