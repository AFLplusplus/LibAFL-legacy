CFLAGS+=-g -fPIC -I./include -I../include -I../AFLplusplus/include -Wall -Wextra -Werror -Wshadow -Wno-variadic-macros -D_FORTIFY_SOURCE=2 -O3 -std=gnu89 #-fno-omit-frame-pointer -fstack-protector-strong -fsanitize=address  -DLLMP_DEBUG=1
LDFLAGS+=-shared
